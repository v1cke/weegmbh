    ...
    <section className="login__area pt-110 pb-110">
      ...
      <h4 className="pt-40 pb-1">Einleitung</h4>
          <p>
            ...
            insbesondere auf unseren Webseiten, mobil, als auch innerhalb
          ...
          <p>
            ...
            Wir setzen Cookies im Einklang mit den gesetzlichen Vorschriften
            ein. Daher holen wir von den Nutzern eine vorhergehende Einwilligung
            ein, außer wenn diese gesetzlich nicht gefordert ist. Eine
            Einwilligung ist insbesondere nicht notwendig, wenn das Speichern
            ...
            Verfügung zu stellen. Die widerrufliche Einwilligung wird gegenüber
            den Nutzern deutlich kommuniziert und enthält die Informationen zu
          ...
          <ul>
            ...
            <li>
              ...
              der Nutzer eine Website erneut besucht. Ebenso können die mit
              Hilfe von Cookies erhobenen Daten der Nutzer zur
              Reichweitenmessung verwendet werden. Sofern wir Nutzern
              &nbsp;keine expliziten Angaben zur Art und Speicherdauer von
          ...
          <p>
            ...
            Nutzerkonto, kurz &#8222;Kundenkonto &#8220;). Falls die
          ...
          <ul>
            <li>
              <strong>Verarbeitete Datenarten:</strong>
              Bestandsdaten (z.B. Namen, Adressen), Zahlungsdaten (z.B.
              Bankverbindungen, Rechnungen, Zahlungshistorie), Vertragsdaten
          ...
          <p>
            ...
            Risiken eingehen (z.B. beim Bestellung auf Rechnung), behalten wir
            uns vor, zur Wahrung der berechtigten Interessen eine Identitäts-
            und Bonitätsauskunft zwecks Beurteilung des Kreditrisikos auf Basis
          ...
          <p>
            ...
            verarbeiten wir im Rahmen einer sachgerechten Ermessensentscheidung
            über die Begründung, Durchführung und Beendigung des
            Vertragsverhältnisses. Wir behalten uns vor, im Fall eines negativen
            Ergebnisses der Bonitätsprüfung, die Zahlung auf Rechnung oder eine
            andere Vorleistung zu verweigern.
          </p>
          <p>
            Die Entscheidung, ob wir in Vorleistung treten, erfolgt entsprechend
            Art. 22 DSGVO alleine auf Grundlage einer automatisierten
            Entscheidung im Einzelfall, die unsere Software unter Zugrundelegung
            der Auskunft der Wirtschaftsauskunftei vornimmt.
          </p>
          <p>
            ...
            Bonitätsauskunft auf Grundlage unserer berechtigten Interessen an
            der Ausfallsicherheit unserer Zahlungsforderungen.
          </p>
          <ul>
            <li>
              <strong>Verarbeitete Datenarten:</strong>
          ...
          <ul>
            <li>
              ...
              Creditreform e.V., Hellersbergstraße 12, D-41460 Neuss,
              Deutschland; Website:{" "}
          ...
          <ul>
            <li>
              ...
              GmbH &amp;Co. KG, //CRASH Building, Schafjückenweg 2, 26180
              Rastede, Deutschland;&nbsp;Website:&nbsp;
              <a
            ...
            <li>
              ...
              &#8222;Mailchimp &#8220;&#8211;Rocket Science Group, LLC, 675
          ...
          <p>
            ...
            Onlineangebotes und kann Verhalten, Interessen oder demographische
            Informationen zu den Besuchern, wie z.B. das Alter oder das
            Geschlecht, als pseudonyme Werte umfassen. Mit Hilfe der
          ...
          <ul>
            ...
            <li>
              ...
              Besuchsaktionsauswertung, Profiling (Erstellen von
              Nutzerprofilen).
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              die Erkennnung wiederkehrender Nutzer mit Hilfe eines so genannten
              &#8222;digitalen Fingerabdrucks &#8220;erfolgt, der anonymisiert
              gespeichert und alle 24 Stunden geändert wird; Beim
              &#8222;digitalen Fingerabdruck &#8220;werden Nutzerbewegungen
              innerhalb unseres Onlineangebotes mit Hilfe von pseudonymisierten
              IP-Adressen in Kombination mit nutzerseitige Browsereinstellungen
              so erfasst, dass Rückschlüsse auf die Identität einzelner Nutzer
              nicht möglich sind. Die im Rahmen der Nutzung von Matomo erhobenen
          ...
          <ul>
            ...
            <li>
              ...
              Onlineangebotes eingeschränkt werden. Wir empfehlen daher
              zusätzlich die folgenden Opt-Out-Möglichkeiten, die
              zusammenfassend auf jeweilige Gebiete gerichtet angeboten
              werden:a) Europa:{" "}
          ...
          <ul>
            ...
            <li>
              ...
              Webanalyse;&nbsp;Dienstanbieter:&nbsp;Google Ireland Limited,
              Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen:
              Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043,
              USA;&nbsp;Website:&nbsp;
              <a
            ...
            <li>
              ...
              Nutzern angezeigt werden, die ein mutmaßliches Interesse an den
              Anzeigen haben. Ferner messen wir die Konversion der Anzeigen. Wir
              erfahren jedoch nur die anonyme Gesamtanzahl der Nutzer, die auf
              unsere Anzeige geklickt haben und zu einer mit einem sog
            ...
            <li>
              ...
              uns Anzeigen für und innerhalb unseres Onlineangebotes gezielter
              anzuzeigen, um Nutzern nur Anzeigen zu präsentieren, die
              potentiell deren Interessen entsprechen. Falls einem Nutzer z.B.
            ...
            <li>
              ...
              Darstellung von Anzeigen (sogenannte &#8222;Facebook-Ads &#8220;)
              zu bestimmen. Dementsprechend setzen wir das Facebook-Pixel ein,
              um die durch uns geschalteten Facebook-Ads nur solchen Nutzern bei
              Facebook und innerhalb der Dienste der mit Facebook kooperierenden
              Partner (so genanntes &#8222;Audience Network &#8220;&nbsp;
              <a
              ...
              Interesse an bestimmten Themen oder Produkten, die anhand der
              besuchten Webseiten ersichtlich werden) aufweisen, die wir an
              Facebook übermitteln (sogenannte &#8222;Custom Audiences“). Mit
              Hilfe des Facebook-Pixels möchten wir auch sicherstellen, dass
              ...
              Facebook &#8220;(https://developers.facebook.com/terms) im
              Hinblick auf die eigenverantwortliche Verarbeitung von Eventdaten
              von Facebook im Rahmen der Anzeigenschaltung;&nbsp;Weitere
              Informationen: Es gelten die &#8222;Datenverarbeitungsbedingungen
              &#8220;(https://www.facebook.com/legal/terms/dataprocessing/update)
              im Hinblick auf Eventdaten, die Facebook im Auftrag verarbeitet,
              um Unternehmen Berichte und Analysen bereitzustellen; Ferner gilt
              der &#8222;Zusatz für Verantwortliche &#8220;als Vereinbarung über
              ...
              Facebook zu Zwecken des Targetings sowie Verbesserung und
          ...
          <ul>
            ...
            <li>
              ...
              Personen mit ihren Seiten und mit den mit ihnen verbundenen
              Inhalten interagieren. Wir haben mit Facebook eine spezielle
            ...
            <li>
              <strong>Xing:&nbsp;</strong>
              Soziales Netzwerk;&nbsp;Dienstanbieter:&nbsp;XING AG,
          ...
          <p>
            ...
            Social-Media-Schaltflächen sowie Beiträge handeln (nachfolgend
          ...
          <ul>
            ...
            <li>
              ...
              interessens-/verhaltensbezogenes Profiling, Nutzung von Cookies),
              Interessenbasiertes und verhaltensbezogenes Marketing, Profiling
              (Erstellen von Nutzerprofilen), Sicherheitsmaßnahmen, Verwaltung
          ...
          <ul>
            <li>
              ...
              Facebook teilen können. Die Liste und das Aussehen der Facebook
              Social Plugins können hier eingesehen werden:
              https://developers.facebook.com/docs/plugins/ &#8211;Wir sind
              gemeinsam mit Facebook Irland Ltd. für die Erhebung oder den
              ...
              Nachrichten (z. B. Ansprache von Nutzern via Facebook-Messenger);
              c) Verbesserung der Anzeigenauslieferung und Personalisierung von
              Funktionen und Inhalten (z. B. Verbesserung der Erkennung, welche
              Inhalte oder Werbeinformationen mutmaßlich den Interessen der
              Nutzer entsprechen). Wir haben mit Facebook eine spezielle
              ...
              oder Löschungsanfragen direkt an Facebook richten). Hinweis: Wenn
            ...
            <li>
              ...
              lizenzrechtlicher Restriktionen für deren
              Einbindung;&nbsp;Dienstanbieter:&nbsp;Google Ireland Limited,
              Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen:
              Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043,
              USA;&nbsp;Website:&nbsp;
              <a
            ...
            <li>
              ...
              Wir binden die Funktion &#8222;reCAPTCHA &#8220;ein, um erkennen
              zu können, ob Eingaben (z.B. in Onlineformularen) von Menschen und
              nicht von automatisch agierenden Maschinen (sogenannten
              &#8222;Bots &#8220;) getätigt werden. Zu den verarbeiteten Daten
              können IP-Adressen, Informationen zu Betriebssystemen, Geräten
              oder verwendeten Browsern, Spracheinstellungen, Standort,
              Mausbewegungen, Tastaturanschläge, Verweildauer auf Webseiten,
              ...
              Auswahl von Objekten in Bildern)
              gehören;&nbsp;Dienstanbieter:&nbsp;Google Ireland Limited, Gordon
              House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google
              LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043,
              USA;&nbsp;Website:&nbsp;
              <a
            ...
            <li>
              ...
              Twitter Plugins und -Schaltflächen &#8211;Hierzu können z.B.
              Inhalte wie Bilder, Videos oder Texte und Schaltflächen gehören,
              mit denen Nutzer Inhalte dieses Onlineangebotes innerhalb von
              Twitter teilen können;&nbsp;Dienstanbieter:&nbsp;Twitter
              International Company, One Cumberland Place, Fenian Street, Dublin
              2 D02 AX07, Irland, Mutterunternehmen: Twitter Inc., 1355 Market
            ...
            <li>
              <strong>Vimeo:&nbsp;</strong>
              Videoinhalte;&nbsp;Dienstanbieter:&nbsp;Vimeo Inc., Attention:
          ...
          <ul>
            <li>
              ...
              auch für ein auf diese Bestimmungen gestütztes Profiling. Werden
            ...
            <li>
              ...
              Orts des mutmaßlichen Verstoßes Beschwerde einzulegen, wenn Sie
          ...
          <ul>
            <li>
              ...
              Tracking &#8220;) bezeichnet ein Verfahren, mit dem die
            ...
            <li>
              ...
              Entscheidungen sind nach Art. 22 DSGVO nur zulässig, wenn
              Betroffene einwilligen, wenn sie für eine Vertragserfüllung
              erforderlich sind oder wenn nationale Gesetze diese Entscheidungen
              erlauben.
            </li>
            <li>
              ...
              geräteübergreifend in sogenannten Profilen erfasst werden, indem
              den Nutzern eine Onlinekennung zugeordnet wird. Hierdurch können
              die Nutzerinformationen unabhängig von verwendeten Browsern oder
              Geräten (z.B. Mobiltelefonen oder Desktopcomputern) im Regelfall
              für Marketingzwecke analysiert werden. Die Onlinekennung ist bei
              den meisten Anbietern nicht mit Klardaten, wie Namen, Postadressen
              oder E-Mail-Adressen, verknüpft.
            </li>
            <li>
            ...
            <li>
              ...
              man, wenn potentielle Interessen von Nutzern an Anzeigen und
              sonstigen Inhalten möglichst genau vorbestimmt werden. Dies
              geschieht anhand von Angaben zu deren Vorverhalten (z.B. Aufsuchen
              von bestimmten Webseiten und Verweilen auf diesen, Kaufverhaltens
              oder Interaktion mit anderen Nutzern), die in einem sogenannten
              Profil gespeichert werden. Zu diesen Zwecken werden im Regelfall
              Cookies eingesetzt.
            </li>
            <li>
            ...
            <li>
              ...
              Verhaltens- und Interessensinformationen in Cookies oder auf
              Servern der Anbieter der Trackingtechnologien gespeichert
            ...
            <li>
              ...
              Von Zielgruppenbildung (bzw. &#8222;Custom Audiences“) spricht
              man, wenn Zielgruppen für Werbezwecke, z.B. Einblendung von
              ...
              betrachtet hat, interessiert. Von &#8222;Lookalike Audiences“
              (bzw. ähnlichen Zielgruppen) spricht man wiederum, wenn die als
              geeignet eingeschätzten Inhalte Nutzern angezeigt werden, deren
              Profile bzw. Interessen mutmaßlich den Nutzern, zu denen die
              Profile gebildet wurden, entsprechen. Zu Zwecken der Bildung von
              Custom Audiences und Lookalike Audiences werden im Regelfall
