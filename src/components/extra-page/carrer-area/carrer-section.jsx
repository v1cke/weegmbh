...
// import video from "@assets/video/weeImageVideo.mp4";
        ...
        >
          <div className="col-md-8">
            <div className="section__title mb-55 text-center">
              <h2 className="sub-title">Karriere</h2>
              <ReactPlayer
                url="/assets/video/weeImageVideo.mp4"
                width="100%"
                height="auto"
                controls
              />
              <h2 className="title" style={{ marginTop: "32px" }}>
