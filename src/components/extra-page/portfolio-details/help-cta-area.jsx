...
const HelpCtaArea = () => {
    return (
        <section className="help__cta overlay bg-css overlay-red pt-50 pb-20" style={{ backgroundImage: `url(${bg_overlay.src})`, margin: "30px 0 50px" }}>
                ...
                <div className="row align-items-center wow fadeInUp" data-wow-duration="1.5s"
                    ...
                    <div className="col-md-4">
                        <div className="help__cta-btn text-lg-end mb-30">
                            <Link className="skew-btn" href="/contact">Kontakt</Link>
                        </div>
                    </div>
                </div>
            </div>
